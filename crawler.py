...
class Crawler:
    ...
    ".epub", ".mobi", ".docx", ".doc", ".opf", ".7z", ".ibooks", ".cbr", ".avi", ".mkv", ".mp4", ".jpg", ".jpeg",
    ...
    def __crawl(self, current_url):
        ...
        if self.images:
            ...
            for image_link in list(set(images)):
                ...
                if self.can_fetch(image_link):
                    ...
                    image_list = "{0}<image:image><image:loc>{1}</image:loc></image:image>".format(image_list,
        ...
        print("<url><loc>" + self.htmlspecialchars(url.geturl()) + "</loc>" + lastmod + image_list + "</url>",
